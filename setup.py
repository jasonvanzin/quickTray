...
excludes = ['_gtkagg', '_tkagg', 'bsddb', 'curses', 'email', 'pywin.debugger',
            ...
            'Tkconstants', 'Tkinter']
packages = []
dll_excludes = ['libgdk-win32-2.0-0.dll', 'libgobject-2.0-0.dll', 'mswsock.dll',
                'powrprof.dll', 'tcl84.dll', 'tk84.dll']
icon_resources = []
bitmap_resources = []
other_resources = []
...
GUI2Exe_Target_1 = Target(
    ...
    author_email = 'sunny@faecbawks.com', description = 'Custom quick-access shortcuts!', author = 'Justin Swanson', 
